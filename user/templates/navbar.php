<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
    <ul class="navbar-nav mr-auto">
        <li class="nav-item">
            ...
            <div class="navbarFont d-none text-white mr-3" id="homeNavBarFont">Home</div>
        </li>
        <li class="nav-item">
            ...
            <div class="navbarFont d-none text-white mr-3" id="calcNavBarFont">Mull Kalkulator</div>
        </li>
        <?php
        ...
        <li class="nav-item">
            ...
            <div class="navbarFont d-none text-white mr-3" id="locNavBarFont">Lokasi</div>
        </li>
    </ul>
